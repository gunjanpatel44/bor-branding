          ...
          {slides.map((slide, index) => (
            ...
            >
              ...
              >
                ...
                />
                <div
                  className={`absolute inset-0 bg-gradient-to-t from-black/80 via-black/40 to-transparent flex flex-col items-center justify-end text-center text-white px-8 py-4 transition-opacity duration-500 ${
                    index === selectedIndex ? 'opacity-100' : 'opacity-0'
                  }`}
                >
                  <h3 className="text-2xl md:text-3xl font-extrabold uppercase tracking-widest">
                    {slide.title}
                  </h3>
                  <p className="max-w-xs text-gray-300 my-2">{slide.subtitle}</p>
